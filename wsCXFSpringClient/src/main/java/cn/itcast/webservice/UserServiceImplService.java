 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://webservice.itcast.cn/", wsdlLocation = "http://localhost:8090/wsCXFSpringServer/ws/userService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.itcast.cn/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/wsCXFSpringServer/ws/userService?wsdl");
    ...
    public IUserService getUserServiceImplPort() {
        return super.getPort(new QName("http://webservice.itcast.cn/", "UserServiceImplPort"), IUserService.class);
    }
    ...
    public IUserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.itcast.cn/", "UserServiceImplPort"), IUserService.class, features);
    }
