...
public class Factory extends BaseEntity implements Serializable{
	...
	public Factory(String ctype, String fullName, String factoryName,
			String contacts, String phone, String mobile, String fax,
			String address, String inspector, String remark, Integer orderNo,
			Integer state) {
		super();
		this.ctype = ctype;
		this.fullName = fullName;
