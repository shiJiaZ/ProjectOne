...
public class Encrypt
 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 */
		System.out.println("md5:"+new Md5Hash("123456","zhiqiang",2).toString());
		/*
		*//**
		 * "123456", "tony", 2:41a5985c62012f246cdd9bcdc8f518339ff70f56
		 *//*
		System.out.println("sha1:"+new Sha1Hash("123456", "tony", 2));
		
		System.out.println("sha256:"+new Sha256Hash("123456", "tony", 2));
		System.out.println("sha384:"+new Sha384Hash("123456", "tony", 2));
		System.out.println("sha512:"+new Sha512Hash("123456", "tony", 2));*/
