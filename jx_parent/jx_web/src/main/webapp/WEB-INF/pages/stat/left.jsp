    ...
    <div class="panel">
        ...
        <div class="panel-content">
			<%-- <ul>
			 ...
			 <li><a href="${ctx}/stat/statChartAction_productsaleJson" onclick="linkHighlighted(this)" target="main" id="aa_1">产品销量排行json</a></li>					
			  <li><a href="${ctx}/stat/statChartAction_onlineInfoJson" onclick="linkHighlighted(this)" target="main" id="aa_1">系统访问压力图json</a></li>					
			 <li><a href="${ctx}/stat/statChartAction_onlineInfoHcharts" onclick="linkHighlighted(this)" target="main" id="aa_1">系统访问压力图hcharts</a></li>					
			  <li><a href="${ctx}/stat/statChartAction_echarts" onclick="linkHighlighted(this)" target="main" id="aa_1">echarts</a></li>					
