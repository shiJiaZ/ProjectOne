...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('outProductAction_print','_self');this.blur();">打印xls</a></li>
<li id="save"><a href="#" onclick="formSubmit('pdfAction_print','_self');this.blur();">打印pdf</a></li>
</ul>
  </div>
</div>
</div>
