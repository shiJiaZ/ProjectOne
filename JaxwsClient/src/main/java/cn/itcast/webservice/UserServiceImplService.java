 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://webservice.itcast.cn/", wsdlLocation = "http://127.0.0.1:12345/userService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:12345/userService?wsdl");
